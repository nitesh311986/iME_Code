...
class Marketing_Details(BasePage):
    marketingIcon = (By.XPATH, "//div[@data-testid='ps-sidebar-container-test-id']/div/div[2]/nav/ul/li[9]/a")
    ...
    def click_on_marketing_icon(self):
        time.sleep(4)
        self.de_click(self.marketingIcon)
        time.sleep(4)

    def fetch_overall_marketing_interviews_details(self):
        log.logger.info("!!! == Assert that digit of Marketing interviews displayed should match the total number of "
                        "interview"
                        "details list  == !!!")
    ...
    def fetch_interview_position_applicant_numbers_for_marketing(self):
        log.logger.info(
            "!!! == Fetch the list of Marketing interview position and applicant appeared for particular position == !!!")
    ...
    def traverse_marketing_interview_list(self):
        log.logger.info(
            "!!! == Fetch the details of all interviewer appeared in the Marketing interviews for same position  == !!!")
        totalNumberOfInterviews = self.get_element_text(self.numberOfInterview)
        number = totalNumberOfInterviews.split()
        numberOfInterviews = number[0]
        log.logger.info("Number Of Interviews == " + str(totalNumberOfInterviews))
    ...
    def filter_interview_details(self):
        log.logger.info(
            "!!! == Filter the details of all interviewer appeared in the Marketing interview based on interview status  == !!!")
        totalNumberOfInterviews = self.get_element_text(self.numberOfInterview)
        number = totalNumberOfInterviews.split()
        numberOfInterviews = number[0]
        log.logger.info("Number Of Interviews == " + str(totalNumberOfInterviews))
    ...
    def filter_interview_details_through_search(self):
        log.logger.info(
            "!!! == Filter the details of all interviewer appeared in the Marketing interview based on interviewer Name  == !!!")
        totalNumberOfInterviews = self.get_element_text(self.numberOfInterview)
        number = totalNumberOfInterviews.split()
        numberOfInterviews = number[0]
        log.logger.info("Number Of Interviews == " + str(totalNumberOfInterviews))
        if int(numberOfInterviews) > 0:
            ...
            time.sleep(0.5)
            log.logger.info(
                "!!! == Filtered the details of all interviewer appeared in the Marketing interview based on interview "
    ...
    def test_your_rating_function(self):
        log.logger.info(
            "!!! == Update Or Add Rating Star Function For Marketing Interview   == !!!")
    ...
    def test_multimedia_resubmission(self):
        log.logger.info(
            "!!! == Resubmit  Multimedia Request Test Case For Marketing == !!!")
        time.sleep(1)
    ...
    def test_update_interview_status(self):
        log.logger.info(
            "!!! == Update The Status Of Marketing Interview == !!!")
        time.sleep(1)
        self.de_click(self.backApplicantProfile)
        time.sleep(1.5)
        self.de_click(self.backApplicationPage)
    ...
    def fetch_interview_transcript(self):
        log.logger.info("==== Verify and fetched transcription of Marketing interviews ==== ")
        self.de_click(self.backApplicationPage)
        time.sleep(1.5)
        totalNumberOfInterviews = self.get_element_text(self.numberOfInterview)
        number = totalNumberOfInterviews.split()
    ...
    def test_create_multiway_for_marketing(self):
        time.sleep(2)
        log.logger.info("!!! == Create Multiway Vide Session From Marketing Vertical  == !!!")
        totalNumberOfInterviews = self.get_element_text(self.numberOfInterview)
        number = totalNumberOfInterviews.split()
        numberOfInterviews = number[0]
        log.logger.info("Number Of Interviews == " + str(totalNumberOfInterviews))
