...
class Audition_Details(BasePage):
    auditionIcon = (By.XPATH, "//div[@data-testid='ps-sidebar-container-test-id']/div/div[2]/nav/ul/li[11]/a")
    ...
    rateIcon = (By.XPATH, "//div[@class='flex items-center justify-between']/div/div[4]/*[local-name()='svg']")
    ...
    def click_on_audition_icon(self):
        time.sleep(5)
        self.de_click(self.auditionIcon)
        time.sleep(4)

    def fetch_overall_audition_interviews_details(self):
        log.logger.info("!!! == Assert that digit of Audition interviews displayed should match the total number of "
                        "interview"
                        "details list  == !!!")
    ...
    def fetch_interview_position_applicant_numbers_for_audition(self):
        log.logger.info(
            "!!! == Fetch the list of Audition interview position and applicant appeared for particular position == !!!")
    ...
    def traverse_audition_interview_list(self):
        log.logger.info(
            "!!! == Fetch the details of all interviewer appeared in the Audition interviews for same position  == !!!")
        totalNumberOfInterviews = self.get_element_text(self.numberOfInterview)
        number = totalNumberOfInterviews.split()
        numberOfInterviews = number[0]
        log.logger.info("Number Of Interviews == " + str(totalNumberOfInterviews))
    ...
    def filter_interview_details(self):
        log.logger.info(
            "!!! == Filter the details of all interviewer appeared in the Audition interview based on interview status  == !!!")
        totalNumberOfInterviews = self.get_element_text(self.numberOfInterview)
        number = totalNumberOfInterviews.split()
        numberOfInterviews = number[0]
        log.logger.info("Number Of Interviews == " + str(totalNumberOfInterviews))
        if int(numberOfInterviews) > 0:
            ...
            log.logger.info(
                "!!! == Filtered the details of all interviewer appeared in the Audition interview based on interview "
                "status  === !!!" + str(status))
            time.sleep(0.5)
            self.de_click(self.filterButton)
            time.sleep(0.5)
    ...
    def filter_interview_details_through_search(self):
        log.logger.info(
            "!!! == Filter the details of all interviewer appeared in the Audition interview based on interviewer Name  == !!!")
        totalNumberOfInterviews = self.get_element_text(self.numberOfInterview)
        number = totalNumberOfInterviews.split()
        numberOfInterviews = number[0]
        log.logger.info("Number Of Interviews == " + str(totalNumberOfInterviews))
    ...
    def test_update_interview_status(self):
        log.logger.info(
            "!!! == Update The Status Of Interview of Audition == !!!")
        time.sleep(1)
        self.de_click(self.backApplicantProfile)
        time.sleep(1.5)
        self.de_click(self.backApplicationPage)
    ...
    def fetch_interview_transcript(self):
        log.logger.info("==== Verify and fetched transcription of Audition interviews ==== ")
        self.de_click(self.backApplicationPage)
        time.sleep(1.5)
        totalNumberOfInterviews = self.get_element_text(self.numberOfInterview)
        number = totalNumberOfInterviews.split()
    ...
    def test_create_multiway_for_audition(self):
        time.sleep(2)
        log.logger.info("!!! == Create Multiway Vide Session From Audition Vertical  == !!!")
        totalNumberOfInterviews = self.get_element_text(self.numberOfInterview)
        number = totalNumberOfInterviews.split()
        numberOfInterviews = number[0]
        log.logger.info("Number Of Interviews == " + str(totalNumberOfInterviews))
