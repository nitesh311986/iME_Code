...
class Awards_Details(BasePage):
    awardIcon = (By.XPATH, "//div[@data-testid='ps-sidebar-container-test-id']/div/div[2]/nav/ul/li[8]/a")
    ...
    def click_on_award_icon(self):
        time.sleep(5)
        self.de_click(self.awardIcon)
        time.sleep(4)

    def fetch_overall_award_interviews_details(self):
        log.logger.info(
            "!!! == Assert that digit of Award interviews displayed should match the total number of interview "
            "details list  == !!!")
    ...
    def fetch_interview_position_applicant_numbers_for_award(self):
        log.logger.info(
            "!!! == Fetch the list of Award interview position and applicant appeared for particular position == !!!")
    ...
    def traverse_award_interview_list(self):
        log.logger.info(
            "!!! == Fetch the details of all interviewer appeared in the Award interviews for same position  == !!!")
        totalNumberOfInterviews = self.get_element_text(self.numberOfInterview)
        number = totalNumberOfInterviews.split()
        numberOfInterviews = number[0]
        log.logger.info("Number Of Interviews == " + str(totalNumberOfInterviews))
    ...
    def filter_interview_details(self):
        log.logger.info(
            "!!! == Filter the details of all interviewer appeared in the Award interview based on interview status  == !!!")
        totalNumberOfInterviews = self.get_element_text(self.numberOfInterview)
        number = totalNumberOfInterviews.split()
        numberOfInterviews = number[0]
        log.logger.info("Number Of Interviews == " + str(totalNumberOfInterviews))
    ...
    def filter_interview_details_through_search(self):
        log.logger.info(
            "!!! == Filter the details of all interviewer appeared in the Award interview based on interviewer Name  == !!!")
        totalNumberOfInterviews = self.get_element_text(self.numberOfInterview)
        number = totalNumberOfInterviews.split()
        numberOfInterviews = number[0]
        log.logger.info("Number Of Interviews == " + str(totalNumberOfInterviews))
    ...
    def test_your_rating_function(self):
        log.logger.info(
            "!!! == Update Or Add Rating Star Function For Award Interview   == !!!")
    ...
    def test_multimedia_resubmission(self):
        log.logger.info(
            "!!! == Resubmit  Multimedia Request Test Case For Award == !!!")
        time.sleep(1)
    ...
    def test_update_interview_status(self):
        log.logger.info(
            "!!! == Update The Status Of Interview for Award == !!!")
        time.sleep(1)
        self.de_click(self.backApplicantProfile)
        time.sleep(1.5)
        self.de_click(self.backApplicationPage)
    ...
    def fetch_interview_transcript(self):
        log.logger.info("==== Verify and fetched transcription of Awards interviews ==== ")
        self.de_click(self.backApplicationPage)
        time.sleep(1.5)
        totalNumberOfInterviews = self.get_element_text(self.numberOfInterview)
        number = totalNumberOfInterviews.split()
    ...
    def test_create_multiway_for_award(self):
        time.sleep(2)
        log.logger.info("!!! == Create Multiway Vide Session From Award Vertical  == !!!")
        totalNumberOfInterviews = self.get_element_text(self.numberOfInterview)
        number = totalNumberOfInterviews.split()
        numberOfInterviews = number[0]
        log.logger.info("Number Of Interviews == " + str(totalNumberOfInterviews))
