...
class Recruitment(BasePage):
    ...
    def fetch_interviews_details_via_company(self):
        ...
        log.logger.info(
            "****==Filter Interview Details using search box via company name for recruitment service===***")
            ...
            for r2 in range(1, rows2):
                for p2 in range(1, 2):
                    ...
                    if r2 <= 10:
                        ...
                        log.logger.info(
                            "<< !! Filter recruitment interview list using Search box via company name ===  "
    ...
    def fetch_interviews_details_via_designation(self):
        ...
        log.logger.info("****==Filter Interview Details using search box via Designation for recruitment services "
                        "===***")
        time.sleep(1)
        dataAvail = WebDriverWait(self.driver, 10).until(
            EC.presence_of_element_located((By.XPATH,
                ...
                for p2 in range(1, 2):
                    ...
                    if r2 <= 10:
                        ...
                        if "Web Developer" in value:
                            log.logger.info(
                                "<< !! Filter recruitment interview list using Search box via designation name ===  "
    ...
    def view_details_of_interview(self):
        ...
        log.logger.info("****==View Details Of Interview Of Recruitment Service===***")
        time.sleep(1)
