...
class Admission(BasePage):
    ...
    def fetch_interviews_details_via_company(self):
        ...
        log.logger.info(
            "****==Filter Interview Details using search box via company name for Admission service===***")
            ...
            for r2 in range(1, rows2):
                for p2 in range(1, 2):
                    ...
                    if r2 <= 10:
                        ...
                        log.logger.info(
                            "<< !! Filter admission interview list using Search box via company name ===  "
    ...
    def fetch_interviews_details_via_designation(self):
        ...
        log.logger.info("****==Filter Interview Details using search box via Designation for Admission services "
                        "===***")
            ...
            for r2 in range(1, rows2):
                for p2 in range(1, 2):
                    ...
                    if r2 <= 10:
                        ...
                        log.logger.info(
                            "<< !! Filter admission interview list using Search box via designation name ===  "
    ...
    def view_details_of_interview(self):
        ...
        log.logger.info("****==View Details Of Interview Of Admission Service===***")
        time.sleep(1)
        ...
        if len(value) > 0:
            ...
            totalInterviews = len(self.driver.find_elements(By.XPATH,
                                                            "//div[@class='border-[1px] border-ime-blue-gray-300 dark:border-ime-blue-gray-600 mt-[10px] rounded-md overflow-hidden']/table/tbody/tr"))
            log.logger.info(
                "Value of i" + str(totalInterviews))
            for i in range(totalInterviews):
                ...
                if i < 9:
                    ...
                    log.logger.info("All Interview Data Has Been Fetched")
