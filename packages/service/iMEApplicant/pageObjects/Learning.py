...
class Learning(BasePage):
    ...
    def fetch_interviews_details_via_company(self):
        ...
        log.logger.info(
            "****==Filter Interview Details using search box via company name for Learning service===***")
            ...
            for r2 in range(1, rows2):
                for p2 in range(1, 2):
                    ...
                    if r2 <= 10:
                        ...
                        log.logger.info(
                            "<< !! Filter learning interview list using Search box via company name ===  "
    ...
    def fetch_interviews_details_via_designation(self):
        ...
        log.logger.info("****==Filter Interview Details using search box via Designation for Marketing services "
                        "===***")
        time.sleep(1)
        dataAvail = WebDriverWait(self.driver, 10).until(
            EC.presence_of_element_located((By.XPATH,
            ...
            for r2 in range(1, rows2):
                for p2 in range(1, 2):
                    ...
                    if r2 <= 10:
                        ...
                        log.logger.info(
                            "<< !! Filter learning interview list using Search box via designation name ===  "
    ...
    def view_details_of_interview(self):
        ...
        log.logger.info("****==View Details Of Interview Of Learning Service===***")
        time.sleep(1)
        ...
        if len(value) > 0:
            ...
            for i in range(totalInterviews):
                ...
                if i < 10:
                    ...
                    log.logger.info("Details Of All Element Has Been Fetched")
        else:
            log.logger.info("There's No Data Available")
