...
class Auditions(BasePage):
    ...
    def fetch_interviews_details_via_company(self):
        ...
        log.logger.info(
            "****==Filter Interview Details using search box via company name for Auditions service===***")
        self.de_click(self.auditionsTab)
        time.sleep(3)
            ...
            for r2 in range(1, rows2):
                for p2 in range(1, 2):
                    ...
                    if r2 <= 10:
                        ...
                        log.logger.info(
                            "<< !! Filter audition interview list using Search box via company name ===  "
    ...
    def fetch_interviews_details_via_designation(self):
        ...
        log.logger.info("****==Filter Interview Details using search box via Designation for Auditions services "
                        "===***")
        time.sleep(1)
            ...
            for r2 in range(1, rows2):
                for p2 in range(1, 2):
                    ...
                    if r2 <= 10:
                        ...
                        log.logger.info(
                            "<< !! Filter audition interview list using Search box via designation name ===  "
    ...
    def view_details_of_interview(self):
        ...
        log.logger.info("****==View Details Of Interview Of Auditions Service===***")
        time.sleep(1)
        ...
        if len(value) > 0:
            ...
            for i in range(totalInterviews):
                ...
                if i < 10:
                    ...
                    log.logger.info("Details Of All interview Has been fetched")
