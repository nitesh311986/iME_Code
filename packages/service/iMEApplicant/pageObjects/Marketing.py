...
class Marketing(BasePage):
    ...
    def fetch_interviews_details_via_company(self):
        ...
        log.logger.info(
            "****==Filter Interview Details using search box via company name for Marketing service===***")
            ...
            for r2 in range(1, rows2):
                for p2 in range(1, 2):
                    ...
                    if r2 <= 10:
                        ...
                        log.logger.info(
                            "<< !! Filter marketing interview list using Search box via company name ===  "
            ...
            for r2 in range(1, rows2):
                for p2 in range(1, 2):
                    ...
                    if r2 <= 10:
                        ...
                        log.logger.info(
                            "<< !! Filter marketing interview list using Search box via designation name ===  "
    ...
    def view_details_of_interview(self):
        ...
        log.logger.info("****==View Details Of Interview Of Marketing Service===***")
        time.sleep(1)
        ...
        if len(value) > 0:
            ...
            for i in range(totalInterviews):
                ...
                if i < 10:
                    ...
                    log.logger.info("Details Of Interview Has Been Fetched")
